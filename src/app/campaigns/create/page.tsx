...
import { CampaignTypeSelector } from "@/src/components/campaign-type-selector";
import { CampaignForm, extractTokenAddress } from "@/src/components/campaign-form";
import { useTokenVerification } from "@/src/hooks/useTokenVerification";
import { useAppKitAccount } from "@reown/appkit/react";
import { useClankerVerification } from "@/src/hooks/useClankerVerification";
import { ClankerTokenDetails } from "@/src/types/clanker";
...
export default function CreateCampaignPage() {
  ...
  const { verifyToken: verifyClankerToken, error: clankerVerificationError } = useClankerVerification();
